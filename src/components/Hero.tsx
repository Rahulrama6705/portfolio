...
export default function Hero() {
  return (
    ...
    >
      ...
      >
        <p className="mb-5 font-sans text-[17px] font-semibold uppercase tracking-[0.18em] text-ink/45">
        ...
        <p className="mx-auto mb-10 max-w-[600px] font-sans text-[21px] leading-[1.75] text-ink/70">
          {profile.blurb}
        </p>
        ...
        <div className="mb-10 flex flex-wrap justify-center gap-3">
          <a
            href="#projects"
            className="rounded-md bg-ink px-6 py-3 font-sans text-[18px] font-semibold text-paper no-underline transition-colors duration-200 hover:bg-accent"
          >
            View my work
          </a>
          <a
            href="#contact"
            className="rounded-md border border-ink/20 px-6 py-3 font-sans text-[18px] font-semibold text-ink no-underline transition-colors duration-200 hover:border-accent hover:text-accent"
          >
            Get in touch
          </a>
        </div>

        <div className="flex justify-center gap-6 font-sans text-[18px] text-ink/50">
