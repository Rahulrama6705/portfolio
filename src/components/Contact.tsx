...
export default function Contact() {
  return (
    <section id="contact" className="relative z-[1] mx-auto max-w-[700px] px-[6vw] py-24 pb-32 text-center">
      <Reveal>
        <p className="mb-2 font-serif text-[17px] font-semibold uppercase tracking-[0.18em] text-accent">
          05 · Contact
        </p>
        <h2 className="mb-5 font-serif text-[clamp(34px,4.5vw,50px)] font-bold text-ink">
          Let&apos;s work together
        </h2>
        <p className="mx-auto mb-9 max-w-[480px] font-serif text-[20px] leading-[1.7] text-ink/65">
        ...
        <a
          ...
          className="mb-8 inline-block rounded-md bg-ink px-7 py-3.5 font-serif text-[19px] font-semibold text-paper no-underline transition-colors duration-200 hover:bg-accent"
        >
          {profile.email}
        </a>

        <div className="flex flex-wrap justify-center gap-6 font-serif text-[18px] text-ink/50">
      ...
      <p className="mt-20 font-serif text-[16px] text-ink/35">
